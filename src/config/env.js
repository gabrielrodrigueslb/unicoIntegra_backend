...
export const env = {
  ...
  MULTIPROVIDER_TENANT_DB_HOST: readEnv('MULTIPROVIDER_TENANT_DB_HOST'),
  MULTIPROVIDER_TENANT_DB_PORT: Number(
    readEnv('MULTIPROVIDER_TENANT_DB_PORT', '5432'),
  ),
  MULTIPROVIDER_TENANT_DB_USER: readEnv('MULTIPROVIDER_TENANT_DB_USER'),
  MULTIPROVIDER_TENANT_DB_PASSWORD: readEnv('MULTIPROVIDER_TENANT_DB_PASSWORD'),
  MULTIPROVIDER_TENANT_DB_SSL:
    readEnv('MULTIPROVIDER_TENANT_DB_SSL', 'false').toLowerCase() === 'true',
